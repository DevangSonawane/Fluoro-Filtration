      ...
      <div className="page stack-lg">
        <div>
          ...
          <p className="lead">
            ...
            that fit their process conditions. We work through the actual operating question first, then translate that
            into a clear product recommendation and a quote request.
          </p>
        </div>
